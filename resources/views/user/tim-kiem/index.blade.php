        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center mb-5">
                    <h6 class="text-primary fw-bold">Kết quả tìm kiếm cho: {{ $keyword }}</h6>
            ...
            <div class="row g-4">
                <div ng-if="searchs.length === 0" class="empty-cart">
                    <p>
                        Không có sản phẩm nào phù hợp với từ khóa tìm kiếm.
                    </p>
                </div>
                <div class="col-6 col-md-4 col-lg-3 fade-in" ng-repeat="sanpham in searchs">
